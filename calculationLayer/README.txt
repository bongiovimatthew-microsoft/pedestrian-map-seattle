...
2. Front end makes a call to a backend orchestrator, providing the bounding box of the source and destination, and knobs 
3. Orchestrator calls DataAggregator, which aggregates the correct data from the correct area. Generates a data.json file for the current request 
